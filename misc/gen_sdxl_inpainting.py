...
def main():
    ...
    images: List[Image.Image] = pipe(args.prompt, image=init_image, mask_image=mask_image, num_images_per_prompt=args.num_images, negative_prompt=negative_prompt, **kwargs).images
